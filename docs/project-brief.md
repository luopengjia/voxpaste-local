...
- Integrated optional local text polishing through LM Studio's OpenAI-compatible API, turning spoken text into cleaner writing for chats, notes, and documents.
